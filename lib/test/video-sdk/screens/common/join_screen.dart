...
import 'package:learnfast/test/video-sdk/screens/conference-call/conference_meeting_screen.dart';
import 'package:learnfast/test/video-sdk/widgets/common/joining_details/joining_details.dart';
                                ...
                                if (isJoinMeetingSelected == null &&
                                  ...
                                  MaterialButton(
                                      ...
                                      child: const Text("Create Meeting",
                                          style: TextStyle(fontSize: 16,color: AppColors.whiteofgradeint)),
                                      onPressed: () => {
                                            setState(() {
                                ...
                                if (isJoinMeetingSelected == null &&
                                  ...
                                  MaterialButton(
                                      ...
                                      child: const Text("Join Meeting",
                                          style: TextStyle(fontSize: 16,color:AppColors.bluebutton)),
                                      onPressed: () => {
                                            setState(() {
                                                  isCreateMeetingSelected =
                                                      false;
 ...
 void initCameraPreview() async {
  try {
    ...
    if (track != null) {
      ...
      // Handle null track
      print("Failed to create camera video track");
    }
  } catch (e) {
