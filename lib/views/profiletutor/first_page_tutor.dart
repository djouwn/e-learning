...
import 'package:learnfast/controllers/spec_tutor_add.dart';
import 'package:learnfast/controllers/specialized_in.dart';
import 'package:learnfast/views/profilestudent/courses_page.dart';


// ignore: must_be_immutable
class FirstPageForTutor extends StatelessWidget {
   FirstPageForTutor({super.key});
    SpecialiteTutorController preferncesController=Get.put(SpecialiteTutorController());
